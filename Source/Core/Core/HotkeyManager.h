...
enum Hotkey
{
  ...
  HK_TAS_MAIN_STICK_ESS_UP_LEFT,
  HK_TAS_MAIN_STICK_ESS_UP,
  HK_TAS_MAIN_STICK_ESS_UP_RIGHT,
  HK_TAS_MAIN_STICK_ESS_LEFT,
  HK_TAS_MAIN_STICK_ESS_CENTER,
  HK_TAS_MAIN_STICK_ESS_RIGHT,
  HK_TAS_MAIN_STICK_ESS_DOWN_LEFT,
  HK_TAS_MAIN_STICK_ESS_DOWN,
  HK_TAS_MAIN_STICK_ESS_DOWN_RIGHT,

  // TAS Nunchuk Stick ESS hotkeys
  HK_TAS_NUNCHUK_STICK_ESS_UP_LEFT,
  HK_TAS_NUNCHUK_STICK_ESS_UP,
  HK_TAS_NUNCHUK_STICK_ESS_UP_RIGHT,
  HK_TAS_NUNCHUK_STICK_ESS_LEFT,
  HK_TAS_NUNCHUK_STICK_ESS_CENTER,
  HK_TAS_NUNCHUK_STICK_ESS_RIGHT,
  HK_TAS_NUNCHUK_STICK_ESS_DOWN_LEFT,
  HK_TAS_NUNCHUK_STICK_ESS_DOWN,
...
enum HotkeyGroup : int
{
  ...
  HKGP_FRAME_ADVANCE,
  HKGP_MOVIE,
  HKGP_TAS_MAIN_STICK_ESS,
  HKGP_TAS_NUNCHUK_STICK_ESS,
  HKGP_STEPPING,
  HKGP_PC,
  HKGP_BREAKPOINT,
  HKGP_WII,
